const IndexLogo = () => {
  return <div className="flex flex-col items-center justify-center animate-fade-in">
      <div className="flex items-center">
        ...
        backgroundClip: "text"
      }} className="text-5xl font-balgin tracking-wider uppercase font-thin">
          AITEMA
        </h1>
        <img src="/public/lovable-uploads/801ba41f-3e27-49c2-9f50-4f82fdf1115e.png" alt="Logo" className="h-12 ml-2" />
      </div>
    </div>;
};
